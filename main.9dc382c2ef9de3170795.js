...
var swiper;
_elements__WEBPACK_IMPORTED_MODULE_4__.mediaQueryList.addEventListener('change', function (e) {
  if (e.matches) {
...
function quantity() {
  for (var i = 6; i < _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends.length; i++) {
    if (_elements__WEBPACK_IMPORTED_MODULE_4__.mediaQueryListMedium.matches) {
      _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends[i].classList.add('btn-slides-none');
      console.log(_elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends[i]);
    } else {
      _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends[i].classList.remove('btn-slides-none');
    }
  }
}
_elements__WEBPACK_IMPORTED_MODULE_4__.mediaQueryListMedium.addEventListener('change', quantity);
quantity(_elements__WEBPACK_IMPORTED_MODULE_4__.mediaQueryListMedium);
console.log(quantity);
var mediaQuery = window.matchMedia('(max-width: 900px)');
function quantitySlides() {
  if (mediaQuery.matches) {
    for (var j = 7; j < _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends.length; j++) {
      _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends[j].classList.add('btn-slides-none');
    }
  }
}
mediaQuery.addEventListener('change', quantitySlides);
quantitySlides(mediaQuery);
function element() {
  if (_elements__WEBPACK_IMPORTED_MODULE_4__.mediaQueryListMedium.matches) {
    for (var i = 6; i < _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends.length; i++) {
      _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends[i].classList.toggle('btn-slides-none');
    }
  } else if (mediaQuery.matches) {
    for (var _i = 7; _i < _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends.length; _i++) {
      _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeBrends[_i].classList.toggle('btn-slides-none');
    }
  }
}
_elements__WEBPACK_IMPORTED_MODULE_4__.btnBrends.addEventListener('click', element);
...
/* harmony export */   "mediaQueryList": () => (/* binding */ mediaQueryList),
/* harmony export */   "mediaQueryListMedium": () => (/* binding */ mediaQueryListMedium),
...
var mediaQueryList = window.matchMedia('(max-width: 320px)');
var mediaQueryListMedium = window.matchMedia('(max-width: 760px)');
...
var elementsToSledeBrends = document.querySelectorAll('.brends__slide-content');
var elementsToSledeRepair = document.querySelectorAll('.repair__slide');
...
_elements__WEBPACK_IMPORTED_MODULE_4__.mediaQueryListMedium.addEventListener('change', function (el) {
  if (el.matches <= 760) {
    for (var i = 3; i < _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeRepair.length; i++) {
      _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeRepair[i].classList.add('btn-slides-none');
    }
  }
});
function element() {
  for (var i = 3; i < _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeRepair.length; i++) {
    _elements__WEBPACK_IMPORTED_MODULE_4__.elementsToSledeRepair[i].classList.toggle('btn-slides-none');
  }
}
_elements__WEBPACK_IMPORTED_MODULE_4__.btnRepair.addEventListener('click', element);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\n@font-face {\n  font-family: \"TTLakes\";\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"woff2\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"woff\");\n}\n@font-face {\n  font-family: \"TTLakes\";\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ") format(\"woff2\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ") format(\"woff\");\n}\n@font-face {\n  font-family: \"TTLakes\";\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ") format(\"woff2\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_5___ + ") format(\"woff\");\n}\n.container {\n  max-width: 72rem;\n  padding: 0 1rem;\n  margin: 0 auto;\n  position: relative;\n}\n\n.btn-reset {\n  border: none;\n  outline: none;\n  background-color: transparent;\n  cursor: pointer;\n  padding: 0;\n}\n\na {\n  outline: none;\n}\n\ninput[type=radio] {\n  opacity: 0;\n  z-index: -1;\n  position: absolute;\n}\n\n.btn-on {\n  display: block;\n}\n\n.btn-close {\n  display: none;\n}\n\n.burger-close {\n  display: none;\n}\n\n.body-overflow {\n  overflow: hidden;\n}\n\ndiv .swiper-wrapper {\n  overflow: visible;\n}\n\ndiv > div.btn-slides-none {\n  display: none;\n}\n\nhtml {\n  box-sizing: border-box;\n}\n\n*,\n*::before,\n*::after {\n  box-sizing: inherit;\n}\n\nbody {\n  font-family: \"SFProDisplay\", sans-serif;\n  margin: 0;\n  background-color: #F8F8F8;\n}\n\nh1, h2, h3, h4, h5, h6 {\n  margin: 0;\n  padding: 0;\n}\n\np {\n  margin: 0;\n  padding: 0;\n}\n\nul, ol, menu {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\na {\n  color: inherit;\n  -webkit-text-decoration: none;\n  text-decoration: none;\n}\n\nimg {\n  max-width: 100%;\n}\n\n.header__position {\n  border-bottom: solid #D9FFF5;\n  background-color: var(--white-color);\n  margin-bottom: 1.5rem;\n}\n.header__inner {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-top: 1rem;\n  padding-bottom: 1rem;\n}\n.header__logo {\n  position: relative;\n}\n.header__logo::after {\n  content: \"\";\n  position: absolute;\n  border-right: solid #EAEAEA;\n  top: 0.6rem;\n  right: -0.9rem;\n  height: 1.9rem;\n}\n.header__buttons {\n  display: flex;\n}\n.header__btn-phone, .header__btn-chat, .header__user {\n  display: none;\n}\n.header__btn-repair {\n  padding-right: 1rem;\n}\n\n.burger__menu {\n  width: 100%;\n  height: 100%;\n  display: block;\n  position: fixed;\n  top: 0;\n  left: 0;\n  -webkit-backdrop-filter: blur(0.25rem);\n  backdrop-filter: blur(0.25rem);\n  z-index: 2;\n  -webkit-transform: translateX(100%);\n          transform: translateX(100%);\n  transition: -webkit-transform 1s;\n  transition: transform 1s;\n  transition: transform 1s, -webkit-transform 1s;\n  overflow-y: scroll;\n}\n.burger__menu.active {\n  -webkit-transform: translateX(0);\n          transform: translateX(0);\n}\n.burger__overlay {\n  width: 21rem;\n  position: absolute;\n  left: 0.1rem;\n  padding-left: 1.8rem;\n  padding-top: 1.1rem;\n  background-color: #fff;\n  box-shadow: 1rem 0 3.25rem rgba(14, 24, 80, 0.2);\n}\n.burger__overlay-inner {\n  display: flex;\n  margin-bottom: 2.3rem;\n}\n.burger__btn {\n  padding-right: 1rem;\n}\n.burger__logo {\n  padding-right: 5rem;\n}\n.burger__navigation {\n  margin-bottom: 15rem;\n}\n.burger__list-item {\n  padding-bottom: 1.8rem;\n}\n.burger__list-item:hover {\n  transition: 0.5s;\n  color: #B5B6BC;\n}\n.burger__buttons {\n  display: flex;\n  gap: 1rem;\n  margin-bottom: 1.1rem;\n}\n.burger__mail {\n  display: block;\n  margin-bottom: 0.8rem;\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n}\n.burger__tel {\n  font-family: \"TT Lakes\";\n  font-size: 1.5rem;\n  display: block;\n  margin-bottom: 2.6rem;\n}\n.burger__radio {\n  padding-left: 0;\n  padding-right: 0.4rem;\n  cursor: pointer;\n}\n.burger__radio:hover {\n  color: var(--nav-text-color);\n}\n.burger__radio:active {\n  color: var(--nav-text-color);\n}\n.burger__radio:focus {\n  border: solid var(--pink-color);\n}\n.burger__radio:disabled {\n  color: var(--black-color);\n}\n\n.services__inner {\n  margin-bottom: 1.5rem;\n}\n.services__title {\n  font-family: \"TT Lakes\";\n  font-size: 1.75rem;\n  line-height: 2.5rem;\n  margin-bottom: 1.5rem;\n  position: relative;\n}\n.services__title::before {\n  content: \"\";\n  position: absolute;\n  width: 0.25rem;\n  height: 2.5rem;\n  left: -0.9rem;\n  background: #41F6D7;\n  border-radius: 1px;\n}\n.services__buttons {\n  display: none;\n}\n.services__menu {\n  display: flex;\n  overflow-y: hidden;\n}\n.services__item {\n  white-space: nowrap;\n  display: block;\n  padding: 0.5rem 1rem;\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  color: var(--nav-text-color);\n  transition: 0.3s;\n  border-radius: 6px;\n  border: solid transparent;\n}\n.services__item:hover, .services__item:focus, .services__item:active {\n  transition: 0.3s;\n  background-color: var(--white-color);\n  border: solid #D9FFF5;\n  border-radius: 6px;\n  transition: 0.5s;\n}\n\n.about__inner {\n  margin-bottom: 2.5rem;\n}\n.about__text {\n  font-family: \"TT Lakes\";\n  font-size: 0.9rem;\n  line-height: 1.2rem;\n  margin-bottom: 1rem;\n}\n.about__btn {\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  margin-bottom: 1rem;\n  position: relative;\n  padding-left: 2rem;\n  border: solid transparent;\n}\n.about__btn::before {\n  content: \"«\";\n  position: absolute;\n  font-size: 1.6rem;\n  -webkit-transform: rotate(0.75turn);\n          transform: rotate(0.75turn);\n  left: 0;\n  top: -0.3rem;\n  color: #41f6d7;\n}\n.about__img {\n  border-radius: 5px;\n  max-width: 20rem;\n  max-height: auto;\n}\n\n.brends {\n  margin-bottom: 1.5rem;\n}\n.brends__title-container {\n  border-top: solid #D9FFF5;\n  height: 5rem;\n  background: linear-gradient(156deg, #F8F8F8 0%, #FFFFFF 98.61%);\n  margin-bottom: 2rem;\n}\n.brends__title {\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  line-height: 1.5rem;\n  text-transform: uppercase;\n  color: #B5B6BC;\n  padding: 1rem;\n}\n.brends__slider {\n  position: relative;\n}\n.brends__slider::after {\n  content: \"\";\n  position: absolute;\n  top: -0.75rem;\n  left: 16rem;\n  z-index: 5;\n  width: 2rem;\n  height: 5.8rem;\n  background: linear-gradient(270deg, #F8F8F8 16.84%, rgba(248, 248, 248, 0.0001) 100%);\n}\ndiv .brends__slide {\n  display: flex;\n  max-width: 13rem;\n  border-radius: 5px;\n  padding: 1rem 1rem;\n  border: solid #EAEAEA;\n  margin-bottom: 2rem;\n  background-color: #fff;\n}\n.brends__slide-lenovo, .brends__slide-Samsung {\n  padding-right: 2.5rem;\n  width: 100%;\n  max-width: 6.8rem;\n}\n.brends__slide-Apple, .brends__slide-Hp {\n  padding-right: 6rem;\n  width: 3.25rem;\n}\n.brends__slide-Acer {\n  padding-right: 3.3rem;\n  width: 6rem;\n}\n.brends__slide-Bosch {\n  width: 8rem;\n  padding-right: 1.3rem;\n}\n.brends__slide-ViewSonic, .brends__slide-Sony {\n  padding-right: 1.3rem;\n}\n.brends__btn-onclick {\n  display: none;\n  position: relative;\n  font-family: \"TT Lakes\";\n  font-style: normal;\n  font-weight: 500;\n  font-size: 1rem;\n  line-height: 1.5rem;\n  padding-top: 1.5rem;\n  padding-left: 2rem;\n}\n.brends__btn-onclick::before {\n  content: \"«\";\n  position: absolute;\n  font-size: 1.6rem;\n  -webkit-transform: rotate(0.75turn);\n  transform: rotate(0.75turn);\n  left: 0.2rem;\n  color: #41f6d7;\n}\n\n.swiper-pagination-bullet {\n  min-width: 0.6rem;\n}\n\ndiv .swiper-pagination-bullet-active {\n  background: #B5B6BC;\n}\n\n.repair__title-container {\n  border-top: solid #D9FFF5;\n  height: 5rem;\n  background: linear-gradient(156deg, #F8F8F8 0%, #FFFFFF 98.61%);\n  margin-bottom: 2rem;\n}\n.repair__title {\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  line-height: 1.5rem;\n  text-transform: uppercase;\n  color: #B5B6BC;\n  padding: 1rem;\n}\n.repair__slider {\n  position: relative;\n}\n.repair__slider::after {\n  content: \"\";\n  position: absolute;\n  top: -0.75rem;\n  left: 16rem;\n  z-index: 5;\n  width: 2rem;\n  height: 11.8rem;\n  background: linear-gradient(270deg, #F8F8F8 16.84%, rgba(248, 248, 248, 0.0001) 100%);\n}\ndiv .repair__slide {\n  display: flex;\n  flex-direction: column;\n  width: 13rem;\n  height: 10rem;\n  border: solid #EAEAEA;\n  border-radius: 0.4rem;\n  background-color: #fff;\n  position: relative;\n  margin-bottom: 2rem;\n}\n.repair__slide-text {\n  padding-top: 1rem;\n  padding-left: 1rem;\n}\n.repair__slide-btn {\n  position: absolute;\n  bottom: 1rem;\n  right: 1rem;\n}\n.repair__btn-onclick {\n  display: none;\n  position: relative;\n  font-family: \"TT Lakes\";\n  font-style: normal;\n  font-weight: 500;\n  font-size: 1rem;\n  line-height: 1.5rem;\n  padding-top: 1.5rem;\n  padding-left: 2rem;\n}\n.repair__btn-onclick::before {\n  content: \"«\";\n  position: absolute;\n  font-size: 1.6rem;\n  -webkit-transform: rotate(0.75turn);\n  transform: rotate(0.75turn);\n  left: 0.2rem;\n  color: #41f6d7;\n}\n\n.swiper-wrapper {\n  overflow: hidden;\n}\n\n.price__title-container {\n  border-top: solid #D9FFF5;\n  height: 5rem;\n  background: linear-gradient(156deg, #F8F8F8 0%, #FFFFFF 98.61%);\n  margin-top: 2rem;\n  margin-bottom: 2rem;\n}\n.price__title {\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  line-height: 1.5rem;\n  text-transform: uppercase;\n  color: #B5B6BC;\n  padding: 1rem;\n}\n.price__slider {\n  position: relative;\n}\n.price__slider::after {\n  content: \"\";\n  position: absolute;\n  top: -0.75rem;\n  left: 16rem;\n  z-index: 5;\n  width: 2rem;\n  height: 13.8rem;\n  background: linear-gradient(270deg, #F8F8F8 16.84%, rgba(248, 248, 248, 0.0001) 100%);\n}\ndiv .price__slide {\n  width: 16.3rem;\n  height: 12.5rem;\n  border: solid #EAEAEA;\n  border-radius: 0.4rem;\n  background-color: #fff;\n  position: relative;\n  margin-bottom: 2rem;\n}\n.price__slide-content {\n  padding-top: 1rem;\n  padding-left: 1rem;\n  max-width: 16.25rem;\n}\n.price__slide-text {\n  padding-top: 1rem;\n  padding-left: 1rem;\n}\n.price__slide-title {\n  font-family: \"TT Lakes\";\n  font-size: 0.9rem;\n  line-height: 1rem;\n  color: #B5B6BC;\n  padding-bottom: 0.25rem;\n}\n.price__slide-lining {\n  font-family: \"TT Lakes\";\n  font-size: 0.9rem;\n  line-height: 1.1rem;\n  padding-bottom: 1rem;\n}\n.price__slide-btn {\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  line-height: 1.5rem;\n  color: #fff;\n  width: 4rem;\n  height: 1.5rem;\n  padding: 0.25rem 2.5rem 0.25rem 0.8rem;\n  background: #FF3E79;\n  border-radius: 1rem;\n  position: relative;\n  float: right;\n  margin-top: -3rem;\n  margin-right: 1rem;\n}\n.price__slide-btn::after {\n  content: \"\";\n  position: absolute;\n  display: block;\n  top: 0.8rem;\n  right: 0.7rem;\n  border: solid 2px #fff;\n  border-radius: 7px;\n  background-color: #fff;\n  width: 0.4rem;\n  -webkit-transform: rotate(45deg);\n  transform: rotate(45deg);\n}\n.price__slide-btn::before {\n  content: \"\";\n  position: absolute;\n  display: block;\n  top: 1.1rem;\n  right: 0.7rem;\n  border: solid 2px #fff;\n  border-radius: 7px;\n  background-color: #fff;\n  width: 0.4rem;\n  -webkit-transform: rotate(130deg);\n  transform: rotate(130deg);\n}\n.price__info {\n  margin-top: 1rem;\n}\n.price__info-text {\n  font-family: \"TT Lakes\";\n  font-size: 0.9rem;\n  line-height: 1.25rem;\n  margin-bottom: 1rem;\n}\n.price__info-link {\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  line-height: 1.5rem;\n  text-transform: uppercase;\n  padding-right: 1rem;\n}\n.price__title-desctop {\n  display: none;\n}\n\n.footer {\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n  opacity: 0.72;\n  border-top: solid #D9FFF5;\n  margin-top: 2.5rem;\n}\n.footer__content {\n  font-family: \"TT Lakes\";\n  font-size: 1rem;\n  line-height: 1rem;\n  color: #B5B6BC;\n  mix-blend-mode: normal;\n  margin-top: 1rem;\n  padding-bottom: 1rem;\n}\n@media (min-width: 47.5rem){\n  .header__logo {\n    margin-left: -12.5rem;\n  }\n  .header__logo::after {\n    display: none;\n  }\n  .header__logo::before {\n    content: \"\";\n    position: absolute;\n    border-right: solid #EAEAEA;\n    top: 0.6rem;\n    right: 7.5rem;\n    height: 1.9rem;\n  }\n  .header__btn-phone, .header__btn-chat, .header__user {\n    display: block;\n    padding-left: 1rem;\n  }\n  .header__btn--border {\n    position: relative;\n  }\n  .header__btn--border::after {\n    content: \"\";\n    position: absolute;\n    border-right: solid #EAEAEA;\n    top: 0.4rem;\n    right: -1rem;\n    height: 1.9rem;\n  }\n  .header__btn-repair {\n    padding-left: 2rem;\n  }\n  .about__inner {\n    display: flex;\n  }\n  .about__text {\n    letter-spacing: 0.013rem;\n    line-height: 1.25rem;\n  }\n  .about__img {\n    max-width: 22.5rem;\n    max-height: auto;\n  }\n  .span-tab {\n    display: block;\n  }\n  .brends__slider::after {\n    display: none;\n  }\n  div .brends__slide {\n    max-width: 11.8rem;\n    margin-bottom: 0;\n  }\n  .brends__swiper-wrapper {\n    display: flex;\n    flex-wrap: wrap;\n    gap: 1.5rem;\n  }\n  .brends__btn-onclick {\n    display: block;\n  }\n  .repair__slider::after {\n    display: none;\n  }\n  .repair__slider-wrapper {\n    display: flex;\n    flex-wrap: wrap;\n    gap: 1.5rem;\n  }\n  .repair__btn-onclick {\n    display: block;\n  }\n  .price__slider::after {\n    display: none;\n  }\n  div .price__slide {\n    width: 45rem;\n    height: 4.1rem;\n    margin-bottom: 0;\n    border: none;\n    border-radius: none;\n  }\n  div .price__slide:not(:last-child)::before {\n    content: \"\";\n    border-bottom: solid #EAEAEA;\n    width: 688px;\n    display: block;\n    position: absolute;\n    bottom: 1px;\n    align-items: center;\n    align-content: center;\n    left: 2%;\n  }\n  .price__slide-content {\n    display: grid;\n    grid-template-columns: 22rem 3rem 5.1rem;\n    grid-gap: 43px;\n  }\n  .price__slide-title {\n    display: none;\n  }\n  .price__slide-btn {\n    display: block;\n    margin-top: -2.5rem;\n  }\n  .price__slider-wrapper {\n    display: flex;\n    flex-direction: column;\n    gap: 0;\n    max-width: 45rem;\n    border: solid #fff;\n    border-radius: 0.4rem;\n  }\n  .price__title-desctop {\n    font-family: \"TT Lakes\";\n    font-size: 0.9rem;\n    line-height: 1rem;\n    color: #B5B6BC;\n    padding-left: 1rem;\n    display: grid;\n    grid-template-columns: 23rem 3rem 5.1rem;\n    grid-gap: 43px;\n    margin-bottom: 1rem;\n  }\n}\n@media (min-width: 90rem){\n  .site-wrapper {\n    display: flex;\n  }\n  .header {\n    display: none;\n  }\n  .burger__menu {\n    -webkit-transform: none;\n            transform: none;\n    -webkit-backdrop-filter: none;\n            backdrop-filter: none;\n    position: static;\n    overflow: hidden;\n  }\n  .burger__overlay {\n    position: static;\n  }\n  .burger__overlay-inner {\n    padding-top: 1.5rem;\n  }\n  .burger__btn {\n    display: none;\n  }\n  .burger__logo {\n    padding-right: 7.4rem;\n  }\n  .burger-container {\n    background-color: white;\n    min-height: 100vh;\n  }\n  .services__inner {\n    margin-top: 2.7rem;\n  }\n  .span-desctop {\n    display: block;\n  }\n}", "",{"version":3,"sources":["webpack://./src/index.scss","webpack://./src/style/_fonts.scss","webpack://./src/style/_overall.scss","webpack://./src/style/_global.scss","webpack://./src/style/_var.scss","webpack://./src/style/Components/_header.scss","webpack://./src/style/Components/_burger.scss","webpack://./src/style/Components/_services.scss","webpack://./src/style/Components/_about.scss","webpack://./src/style/Components/_brends-slider.scss","webpack://./src/style/Components/_repair.scss","webpack://./src/style/Components/_price.scss","webpack://./src/style/Components/_footer.scss","webpack://./<no source>"],"names":[],"mappings":"AAAA,gBAAgB;ACAhB;EACE,sBAAA;EACA,oHAAA;ADGF;ACAA;EACE,sBAAA;EACA,oHAAA;ADEF;ACCA;EACE,sBAAA;EACA,oHAAA;ADCF;AEbA;EACE,gBAAA;EACA,eAAA;EACA,cAAA;EACA,kBAAA;AFeF;;AEbA;EACE,YAAA;EACA,aAAA;EACA,6BAAA;EACA,eAAA;EACA,UAAA;AFgBF;;AEbA;EACE,aAAA;AFgBF;;AEbA;EACE,UAAA;EACA,WAAA;EACA,kBAAA;AFgBF;;AEbA;EACE,cAAA;AFgBF;;AEdA;EACE,aAAA;AFiBF;;AEfA;EACE,aAAA;AFkBF;;AEhBA;EACE,gBAAA;AFmBF;;AEjBA;EACE,iBAAA;AFoBF;;AElBA;EACE,aAAA;AFqBF;;AG7DA;EACC,sBAAA;AHsED;;AGnEA;;;EAGC,mBAAA;AHsED;;AGnEA;EACC,uCAAA;EACA,SAAA;EACA,yBCPM;AJ6EP;;AGnEA;EACC,SAAA;EACA,UAAA;AHsED;;AGnEA;EACC,SAAA;EACA,UAAA;AHsED;;AGnEA;EACC,SAAA;EACA,UAAA;EACA,gBAAA;AHsED;;AGnEA;EACC,cAAA;EACA,6BAAA;EAAA,qBAAA;AHsED;;AGnEA;EACC,eAAA;AHsED;;AK1GI;EACI,4BAAA;EACA,oCAAA;EACA,qBAAA;AL6GR;AKtGI;EACI,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,iBAAA;EACA,oBAAA;ALwGR;AKrGI;EACI,kBAAA;ALuGR;AKrGQ;EACI,WAAA;EACA,kBAAA;EACA,2BAAA;EACA,WAAA;EACA,cAAA;EACA,cAAA;ALuGZ;AKnFI;EACI,aAAA;ALqGR;AKlGI;EAGI,aAAA;ALkGR;AK7EI;EACI,mBAAA;ALkGR;;AM/KI;EACA,WAAA;EACA,YAAA;EACA,cAAA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,sCAAA;EACA,8BAAA;EACA,UAAA;EACA,mCAAA;UAAA,2BAAA;EACA,gCAAA;EAAA,wBAAA;EAAA,8CAAA;EACA,kBAAA;AN4LJ;AMnLI;EACI,gCAAA;UAAA,wBAAA;AN6LR;AM1LI;EACA,YAAA;EACA,kBAAA;EACA,YAAA;EACA,oBAAA;EACA,mBAAA;EACA,sBF9BI;EE+BJ,gDAAA;AN4LJ;AMrLI;EACA,aAAA;EACA,qBAAA;AN4LJ;AMrLA;EACI,mBAAA;AN4LJ;AMvLA;EACI,mBAAA;AN8LJ;AMxLA;EACI,oBAAA;AN+LJ;AM7LA;EACI,sBAAA;AN+LJ;AM7LA;EACI,gBAAA;EACA,cFrEG;AJoQP;AM7LA;EACI,aAAA;EACA,SAAA;EACA,qBAAA;AN+LJ;AM7LA;EACI,cAAA;EACA,qBAAA;EACA,uBAAA;EACA,eAAA;AN+LJ;AM7LA;EACI,uBAAA;EACA,iBAAA;EACA,cAAA;EACA,qBAAA;AN+LJ;AM7LA;EACI,eAAA;EACA,qBAAA;EACA,eAAA;AN+LJ;AM7LA;EACI,4BAAA;AN+LJ;AM7LA;EACI,4BAAA;AN+LJ;AM7LA;EACI,+BAAA;AN+LJ;AM7LA;EACI,yBAAA;AN+LJ;;AOrSI;EACI,qBAAA;AP+SR;AOzSI;EACI,uBAAA;EACA,kBAAA;EACA,mBAAA;EACA,qBAAA;EACA,kBAAA;APgTR;AO9SQ;EACI,WAAA;EACA,kBAAA;EACA,cAAA;EACA,cAAA;EACA,aAAA;EACA,mBAAA;EACA,kBAAA;APgTZ;AO5SI;EACI,aAAA;AP8SR;AO5SI;EACI,aAAA;EACA,kBAAA;AP8SR;AO5SI;EACI,mBAAA;EACA,cAAA;EACA,oBAAA;EACA,uBAAA;EACA,eAAA;EACA,4BAAA;EACA,gBAAA;EACA,kBAAA;EACA,yBAAA;AP8SR;AO5SI;EAGI,gBAAA;EACA,oCAAA;EACA,qBAAA;EACA,kBAAA;EACA,gBAAA;AP4SR;;AQ/VI;EACI,qBAAA;ARkWR;AQ5VI;EACI,uBAAA;EACA,iBAAA;EACA,mBAAA;EACA,mBAAA;ARmWR;AQ3VI;EACI,uBAAA;EACA,eAAA;EACA,mBAAA;EACA,kBAAA;EACA,kBAAA;EACA,yBAAA;ARmWR;AQjWQ;EACI,YAAA;EACA,kBAAA;EACA,iBAAA;EACA,mCAAA;UAAA,2BAAA;EACA,OAAA;EACA,YAAA;EACA,cAAA;ARmWZ;AQhWI;EACI,kBAAA;EACA,gBAAA;EACA,gBAAA;ARkWR;;AS3YA;EACI,qBAAA;ATgaJ;AS9ZI;EACI,yBAAA;EACA,YAAA;EACA,+DAAA;EACA,mBAAA;ATgaR;AS7ZI;EACI,uBAAA;EACA,eAAA;EACA,mBAAA;EACA,yBAAA;EACA,cLdD;EKeC,aAAA;AT+ZR;AS5ZI;EACI,kBAAA;AT8ZR;AS5ZQ;EACI,WAAA;EACA,kBAAA;EACA,aAAA;EACA,WAAA;EACA,UAAA;EACA,WAAA;EACA,cAAA;EACA,qFAAA;AT8ZZ;ASpZG;EACK,aAAA;EACA,gBAAA;EACA,kBAAA;EACA,kBAAA;EACA,qBAAA;EACA,mBAAA;EACA,sBL7CA;AJwcR;ASnZI;EAEI,qBAAA;EACA,WAAA;EACA,iBAAA;AT0ZR;ASvZI;EAEI,mBAAA;EACA,cAAA;ATwZR;ASrZI;EACI,qBAAA;EACA,WAAA;ATuZR;ASpZI;EACI,WAAA;EACA,qBAAA;ATsZR;ASnZI;EAEI,qBAAA;AToZR;ASzYI;EACI,aAAA;EACA,kBAAA;EACA,uBAAA;EACA,kBAAA;EACA,gBAAA;EACA,eAAA;EACA,mBAAA;EACA,mBAAA;EACA,kBAAA;ATkZR;AShZQ;EACA,YAAA;EACA,kBAAA;EACA,iBAAA;EACA,mCAAA;EACA,2BAAA;EACA,YAAA;EACA,cAAA;ATkZR;;AS3YA;EACI,iBAAA;ATmZJ;;ASjZA;EACI,mBLnHS;AJugBb;;AU3gBI;EACI,yBAAA;EACA,YAAA;EACA,+DAAA;EACA,mBAAA;AV8gBR;AU3gBI;EACI,uBAAA;EACA,eAAA;EACA,mBAAA;EACA,yBAAA;EACA,cNZD;EMaC,aAAA;AV6gBR;AUzgBI;EACI,kBAAA;AV2gBR;AUzgBQ;EACI,WAAA;EACA,kBAAA;EACA,aAAA;EACA,WAAA;EACA,UAAA;EACA,WAAA;EACA,eAAA;EACA,qFAAA;AV2gBZ;AUjgBI;EACI,aAAA;EACA,sBAAA;EACA,YAAA;EACA,aAAA;EACA,qBAAA;EACA,qBAAA;EACA,sBN5CA;EM6CA,kBAAA;EACA,mBAAA;AVwgBR;AUrgBI;EACI,iBAAA;EACA,kBAAA;AVugBR;AUpgBI;EACI,kBAAA;EACA,YAAA;EACA,WAAA;AVsgBR;AUrfG;EACC,aAAA;EACA,kBAAA;EACA,uBAAA;EACA,kBAAA;EACA,gBAAA;EACA,eAAA;EACA,mBAAA;EACA,mBAAA;EACA,kBAAA;AV8fJ;AU5fI;EACA,YAAA;EACA,kBAAA;EACA,iBAAA;EACA,mCAAA;EACA,2BAAA;EACA,YAAA;EACA,cAAA;AV8fJ;;AUvfA;EACI,gBAAA;AV+fJ;;AWpmBI;EACI,yBAAA;EACA,YAAA;EACA,+DAAA;EACA,gBAAA;EACA,mBAAA;AXumBR;AWpmBI;EACI,uBAAA;EACA,eAAA;EACA,mBAAA;EACA,yBAAA;EACA,cPbD;EOcC,aAAA;AXsmBR;AWlmBI;EACI,kBAAA;AXomBR;AWlmBQ;EACI,WAAA;EACA,kBAAA;EACA,aAAA;EACA,WAAA;EACA,UAAA;EACA,WAAA;EACA,eAAA;EACA,qFAAA;AXomBZ;AWzlBI;EACI,cAAA;EACA,eAAA;EACA,qBAAA;EACA,qBAAA;EACA,sBP5CA;EO6CA,kBAAA;EACA,mBAAA;AXgmBR;AWzkBI;EACI,iBAAA;EACA,kBAAA;EACA,mBAAA;AX+lBR;AWtlBI;EACI,iBAAA;EACA,kBAAA;AX+lBR;AWtlBI;EACI,uBAAA;EACA,iBAAA;EACA,iBAAA;EACA,cPjGD;EOkGC,uBAAA;AXwlBR;AWjlBI;EACI,uBAAA;EACA,iBAAA;EACA,mBAAA;EACA,oBAAA;AXwlBR;AWrlBI;EACI,uBAAA;EACA,eAAA;EACA,mBAAA;EACA,WPnHA;EOoHA,WAAA;EACA,cAAA;EACA,sCAAA;EACA,mBPrHD;EOsHC,mBAAA;EACA,kBAAA;EACA,YAAA;EACA,iBAAA;EACA,kBAAA;AXulBR;AWrlBQ;EACI,WAAA;EACA,kBAAA;EACA,cAAA;EACA,WAAA;EACA,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,sBPtIJ;EOuII,aAAA;EACA,gCAAA;EACA,wBAAA;AXulBZ;AWrlBQ;EACI,WAAA;EACA,kBAAA;EACA,cAAA;EACA,WAAA;EACA,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,sBPnJJ;EOoJI,aAAA;EACA,iCAAA;EACA,yBAAA;AXulBZ;AW9kBI;EACI,gBAAA;AXslBR;AWnlBI;EACA,uBAAA;EACA,iBAAA;EACA,oBAAA;EACA,mBAAA;AXqlBJ;AWllBI;EACI,uBAAA;EACA,eAAA;EACA,mBAAA;EACA,yBAAA;EACA,mBAAA;AXolBR;AWtkBO;EACC,aAAA;AXklBR;;AYlxBA;EACI,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,aAAA;EACA,yBAAA;EACA,kBAAA;AZkyBJ;AYhyBI;EACI,uBAAA;EACA,eAAA;EACA,iBAAA;EACA,cRXD;EQYC,sBAAA;EACA,gBAAA;EACA,oBAAA;AZkyBR;AajzBA;ERoBI;IAYQ,qBAAA;ELwGV;EKvGU;IACI,aAAA;ELyGd;EKtGU;IACI,WAAA;IACA,kBAAA;IACA,2BAAA;IACA,WAAA;IACA,aAAA;IACA,cAAA;ELwGd;EK9FE;IAMQ,cAAA;IACA,kBAAA;ELmGV;EK/FE;IAEI,kBAAA;ELkGN;EKjGM;IACI,WAAA;IACA,kBAAA;IACA,2BAAA;IACA,WAAA;IACA,YAAA;IACA,cAAA;ELmGV;EK/FE;IAIQ,kBAAA;ELmGV;EQnLE;IAIQ,aAAA;ERmWV;EQhWE;IAOQ,wBAAA;IACA,oBAAA;ERoWV;EQ9UE;IAKQ,kBAAA;IACA,gBAAA;ERoWV;EQhWF;IAEQ,cAAA;ERoWN;ESpXc;IACI,aAAA;ET6ZlB;ESxZC;IAUS,kBAAA;IACA,gBAAA;ET4ZV;ES5XE;IAEQ,aAAA;IACA,eAAA;IACA,WAAA;ETmZV;ES/YE;IAqBQ,cAAA;ETmZV;EUlec;IACI,aAAA;EV0gBlB;EUxeC;IAEK,aAAA;IACA,eAAA;IACA,WAAA;EV+fN;EU3fC;IAqBK,cAAA;EV+fN;EW7jBc;IACI,aAAA;EXkmBlB;EW7lBE;IAUQ,YAAA;IACA,cAAA;IACA,gBAAA;IACA,YAAA;IACA,mBAAA;EXimBV;EW/lBU;IACI,WAAA;IACA,4BAAA;IACA,YAAA;IACA,cAAA;IACA,kBAAA;IACA,WAAA;IACA,mBAAA;IACA,qBAAA;IACA,QAAA;EXimBd;EW5lBE;IAMQ,aAAA;IACA,wCAAA;IACA,cAAA;EXgmBV;EWjlBE;IAQQ,aAAA;EXylBV;EW9kBE;IA2CQ,cAAA;IACA,mBAAA;EXulBV;EWhkBE;IAEQ,aAAA;IACA,sBAAA;IACA,MAAA;IACA,gBAAA;IACA,kBAAA;IACA,qBAAA;EXmlBV;EW/kBK;IAIK,uBAAA;IACA,iBAAA;IACA,iBAAA;IACA,cPrML;IOsMK,kBAAA;IACA,aAAA;IACA,wCAAA;IACA,cAAA;IACA,mBAAA;EXmlBV;AAjFF;Aa7sBA;EX0CA;IAEI,aAAA;EFsBF;EKlEF;IAqFQ,aAAA;ELoGN;EMxLE;IAcI,uBAAA;YAAA,eAAA;IACA,6BAAA;YAAA,qBAAA;IACA,gBAAA;IACA,gBAAA;EN8LN;EMtLE;IAUI,gBAAA;EN6LN;EMzLE;IAKI,mBAAA;EN6LN;EMzLF;IAGQ,aAAA;EN8LN;EM3LF;IAIQ,qBAAA;EN+LN;EM9IF;IAEQ,uBAAA;IACA,iBAAA;EN8LN;EO3SE;IAIQ,kBAAA;EPgTV;EQhQF;IAEQ,cAAA;ERoWN;AAqVF","sourcesContent":["@import '~normalize.css';\n@import 'style/fonts';\n@import 'style/var';\n@import 'style/overall';\n@import 'style/global';\n\n\n\n@import 'style/Components/header';\n@import 'style/Components/burger';\n@import 'style/Components/services';\n@import 'style/Components/about';\n@import 'style/Components/brends-slider';\n@import 'style/Components/repair';\n@import 'style/Components/price';\n@import 'style/Components/footer';\n","@font-face {\n  font-family: 'TTLakes';\n  src: url('../fonts/TTLakes-Regular.woff2') format('woff2'),\n    url('../fonts/TTLakes-Regular.woff') format('woff');\n}\n@font-face {\n  font-family: 'TTLakes';\n  src: url('../fonts/TTLakes-Medium.woff2') format('woff2'),\n    url('../fonts/TTLakes-Medium.woff') format('woff');\n}\n@font-face {\n  font-family: 'TTLakes';\n  src: url('../fonts/TTLakes-Bold.woff2') format('woff2'),\n    url('../fonts/TTLakes-Bold.woff') format('woff');\n}\n",".container {\n  max-width: 72rem;\n  padding: 0 1rem;\n  margin: 0 auto;\n  position: relative;\n}\n.btn-reset {\n  border: none;\n  outline: none;\n  background-color: transparent;\n  cursor: pointer;\n  padding: 0;\n}\n\na {\n  outline: none;\n}\n\ninput[type=\"radio\"]{\n  opacity: 0;\n  z-index: -1;\n  position: absolute;\n}\n\n.btn-on{\n  display: block;\n}\n.btn-close{\n  display: none;\n}\n.burger-close{\n  display: none;\n}\n.body-overflow{\n  overflow: hidden;\n}\ndiv .swiper-wrapper {\n  overflow: visible;\n}\ndiv > div.btn-slides-none{\n  display: none;\n}\n.site-wrapper{\n  @media (min-width: 90rem){\n    display: flex;\n  }\n}","html {\n\tbox-sizing: border-box;\n}\n\n*,\n*::before,\n*::after {\n\tbox-sizing: inherit;\n}\n\nbody {\n\tfont-family: 'SFProDisplay', sans-serif;\n\tmargin: 0;\n\tbackground-color: $body;\n}\n\nh1, h2, h3, h4, h5, h6 {\n\tmargin: 0;\n\tpadding: 0;\n}\n\np {\n\tmargin: 0;\n\tpadding: 0;\n}\n\nul, ol, menu {\n\tmargin: 0;\n\tpadding: 0;\n\tlist-style: none;\n}\n\na {\n\tcolor: inherit;\n\ttext-decoration: none;\n}\n\nimg {\n\tmax-width: 100%;\n\t\n}","$back: rgb(41, 41, 9);\n$text: #B5B6BC;\n$white: #fff;\n$border: #EAEAEA;\n$pink: #FF3E79;\n$pagination: #B5B6BC;\n$body: #F8F8F8;\n$line:#D9FFF5;\n\n\n\n",".header{\n\n    &__position{\n        border-bottom: solid #D9FFF5;\n        background-color: var(--white-color);\n        margin-bottom: 1.5rem;\n        // width: 100vw;\n        // margin-left: calc(50% - 50vw);\n\n    }\n\n\n    &__inner {\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        padding-top: 1rem;\n        padding-bottom: 1rem;\n    }\n\n    &__logo{\n        position: relative;\n\n        &::after{\n            content: \"\";\n            position: absolute;\n            border-right: solid $border;\n            top: 0.6rem;\n            right: -0.9rem;\n            height: 1.9rem;\n        }\n        @media (min-width: 47.5rem){\n            margin-left: -12.5rem;\n            &::after{\n                display: none;\n            }\n\n            &::before{\n                content: \"\";\n                position: absolute;\n                border-right: solid $border;\n                top: 0.6rem;\n                right: 7.5rem;\n                height: 1.9rem;\n            }\n        }\n    }\n\n\n    &__buttons{\n        display: flex;\n    }\n\n    &__btn-phone,\n    &__btn-chat ,\n    &__user{\n        display: none;\n\n        @media (min-width: 47.5rem){\n            display: block;\n            padding-left: 1rem;\n        } \n    }   \n\n    &__btn--border{\n        @media (min-width: 47.5rem){\n        position: relative;\n        &::after{\n            content: \"\";\n            position: absolute;\n            border-right: solid $border;\n            top: 0.4rem;\n            right: -1rem;\n            height: 1.9rem;\n        }\n    }}\n\n    &__btn-repair {\n        padding-right: 1rem;\n    \n        @media (min-width: 47.5rem){\n            padding-left: 2rem;\n        }\n    }\n    @media (min-width: 90rem){\n        display: none;\n    }\n}",".burger{\n    &__menu{\n    width: 100%;\n    height: 100%;\n    display: block;\n    position: fixed;\n    top: 0;\n    left: 0;\n    -webkit-backdrop-filter: blur(0.25rem);\n    backdrop-filter: blur(0.25rem);\n    z-index: 2;\n    transform: translateX(100%);\n    transition: transform 1s;\n    overflow-y: scroll;\n    @media (min-width: 90rem){\n        transform: none;\n        backdrop-filter:none;\n        position: static;\n        overflow: hidden;\n    }\n}\n\n    &__menu.active{\n        transform: translateX(0);\n    }\n\n    &__overlay{\n    width: 21rem;\n    position: absolute;\n    left: 0.1rem;\n    padding-left: 1.8rem;\n    padding-top: 1.1rem;\n    background-color: $white;\n    box-shadow: 1rem 0 3.25rem rgba(14, 24, 80, 0.2); \n\n    @media (min-width: 90rem){\n        position: static;\n    }\n    }\n\n    &__overlay-inner{\n    display: flex;\n    margin-bottom: 2.3rem;\n\n    @media (min-width: 90rem){\n        padding-top: 1.5rem;\n    }\n}\n\n&__btn{\n    padding-right: 1rem;\n    @media (min-width: 90rem){\n        display: none;\n    }\n}\n&__logo{\n    padding-right: 5rem;\n\n    @media (min-width: 90rem){\n        padding-right: 7.4rem;\n    }\n}\n&__navigation{\n    margin-bottom: 15rem;\n}\n&__list-item{\n    padding-bottom: 1.8rem;\n}\n&__list-item:hover{\n    transition: 0.5s;\n    color: $text;\n}\n&__buttons{\n    display: flex;\n    gap: 1rem;\n    margin-bottom: 1.1rem;\n}\n&__mail{\n    display: block;\n    margin-bottom: 0.8rem;\n    font-family: 'TT Lakes';\n    font-size: 1rem;\n}\n&__tel{\n    font-family: 'TT Lakes';\n    font-size: 1.5rem;\n    display: block;\n    margin-bottom: 2.6rem;\n}\n&__radio {\n    padding-left: 0;\n    padding-right: 0.4rem;\n    cursor: pointer;\n}\n&__radio:hover{\n    color: var(--nav-text-color);\n}\n&__radio:active{\n    color: var(--nav-text-color);\n}\n&__radio:focus{\n    border: solid var(--pink-color);\n}\n&__radio:disabled{\n    color: var(--black-color);\n}\n}\n\n.burger-container{\n    @media (min-width: 90rem){\n        background-color: white;\n        min-height: 100vh;\n    }\n}",".services{\n\n    &__inner{\n        margin-bottom: 1.5rem;\n\n        @media (min-width: 90rem){\n            margin-top: 2.7rem;\n        }\n    }\n    &__title {\n        font-family: 'TT Lakes';\n        font-size: 1.75rem;\n        line-height: 2.5rem;\n        margin-bottom: 1.5rem;\n        position: relative;\n\n        &::before{\n            content: \"\";\n            position: absolute;\n            width: 0.25rem;\n            height: 2.5rem;\n            left: -0.9rem;\n            background: #41F6D7;\n            border-radius: 1px;\n        }\n    }\n\n    &__buttons{\n        display: none;\n    }\n    &__menu {\n        display: flex;\n        overflow-y: hidden;\n    }\n    &__item {\n        white-space: nowrap;\n        display: block;\n        padding: 0.5rem 1rem;\n        font-family: \"TT Lakes\";\n        font-size: 1rem;\n        color: var(--nav-text-color);\n        transition: 0.3s;\n        border-radius: 6px;\n        border: solid transparent;\n    }\n    &__item:hover,\n    &__item:focus,\n    &__item:active{\n        transition: 0.3s;\n        background-color: var(--white-color);\n        border: solid #D9FFF5;\n        border-radius: 6px;\n        transition: 0.5s;\n    }\n}\n\n",".about{\n    &__inner{\n        margin-bottom: 2.5rem;\n\n        @media (min-width: 47.5rem){\n            display: flex;\n        }\n    }\n    &__text {\n        font-family: 'TT Lakes';\n        font-size: 0.9rem;\n        line-height: 1.2rem;\n        margin-bottom: 1rem;\n\n        @media (min-width: 47.5rem){\n            letter-spacing: 0.013rem;\n            line-height: 1.25rem;\n        }\n    }\n    \n    &__btn {\n        font-family: 'TT Lakes';\n        font-size: 1rem;\n        margin-bottom: 1rem;\n        position: relative;\n        padding-left: 2rem;\n        border: solid transparent;\n\n        &::before{\n            content: \"«\";\n            position: absolute;\n            font-size: 1.6rem;\n            transform: rotate(0.75turn);\n            left: 0;\n            top: -0.3rem;\n            color: #41f6d7;\n        }\n    }\n    &__img {\n        border-radius: 5px;\n        max-width: 20rem;\n        max-height: auto;\n        @media (min-width: 47.5rem){\n            max-width: 22.5rem;\n            max-height: auto;\n        }\n    }\n}\n.span-tab{\n    @media (min-width: 47.5rem){\n        display: block;\n    }\n}\n\n.span-desctop{\n    @media(min-width: 90rem){\n        display: block;\n    }\n}",".brends{\n    margin-bottom: 1.5rem;\n\n    &__title-container{\n        border-top: solid $line;\n        height: 5rem;\n        background: linear-gradient(156deg, #F8F8F8 0%, #FFFFFF 98.61%);\n        margin-bottom: 2rem;\n    }\n\n    &__title{\n        font-family: 'TT Lakes';\n        font-size: 1rem;\n        line-height: 1.5rem;\n        text-transform: uppercase;\n        color: $text;\n        padding: 1rem;\n    }\n\n    &__slider{\n        position: relative;\n\n        &::after{\n            content: \"\";\n            position: absolute;\n            top: -0.75rem;\n            left: 16rem;\n            z-index: 5;\n            width: 2rem;\n            height: 5.8rem;\n            background: linear-gradient(270deg, #F8F8F8 16.84%, rgba(248, 248, 248, 0.0001) 100%);\n            }\n\n            @media (min-width: 47.5rem){\n                &::after{\n                    display: none;\n                }\n            }\n    }\n\n   div &__slide{\n        display: flex;\n        max-width: 13rem;\n        border-radius: 5px;\n        padding: 1rem 1rem;\n        border: solid $border;\n        margin-bottom: 2rem;\n        background-color: $white;\n\n        @media (min-width: 47.5rem){\n            max-width: 11.8rem;\n            margin-bottom: 0;\n        }\n    }\n\n    &__slide-lenovo,\n    &__slide-Samsung{\n        padding-right: 2.5rem;\n        width: 100%;\n        max-width: 6.8rem;\n    }\n\n    &__slide-Apple,\n    &__slide-Hp{\n        padding-right: 6rem;\n        width: 3.25rem;\n    }\n\n    &__slide-Acer{\n        padding-right: 3.3rem;\n        width: 6rem;\n    }\n\n    &__slide-Bosch{\n        width: 8rem;\n        padding-right: 1.3rem;\n    }\n\n    &__slide-ViewSonic,\n    &__slide-Sony{\n        padding-right: 1.3rem;\n    }\n\n    &__swiper-wrapper{\n        @media (min-width: 47.5rem){\n            display: flex;\n            flex-wrap: wrap;\n            gap: 1.5rem;\n        }\n    }\n\n    &__btn-onclick{\n        display: none;\n        position: relative;\n        font-family: 'TT Lakes';\n        font-style: normal;\n        font-weight: 500;\n        font-size: 1rem;\n        line-height: 1.5rem;\n        padding-top: 1.5rem;\n        padding-left: 2rem;\n\n        &::before{\n        content: \"«\";\n        position: absolute;\n        font-size: 1.6rem;\n        -webkit-transform: rotate(0.75turn);\n        transform: rotate(0.75turn);\n        left: 0.2rem;\n        color: #41f6d7;\n        }\n        @media (min-width: 47.5rem){\n            display: block;\n        }\n    }\n}\n.swiper-pagination-bullet{\n    min-width: 0.60rem;\n}\ndiv .swiper-pagination-bullet-active{\n    background: $pagination;\n}",".repair{\n    &__title-container{\n        border-top: solid $line;\n        height: 5rem;\n        background: linear-gradient(156deg, #F8F8F8 0%, #FFFFFF 98.61%);\n        margin-bottom: 2rem;\n    }\n\n    &__title{\n        font-family: 'TT Lakes';\n        font-size: 1rem;\n        line-height: 1.5rem;\n        text-transform: uppercase;\n        color: $text;\n        padding: 1rem;\n    }\n\n    \n    &__slider{\n        position: relative;\n\n        &::after{\n            content: \"\";\n            position: absolute;\n            top: -0.75rem;\n            left: 16rem;\n            z-index: 5;\n            width: 2rem;\n            height: 11.8rem;\n            background: linear-gradient(270deg, #F8F8F8 16.84%, rgba(248, 248, 248, 0.0001) 100%);\n            }\n\n            @media (min-width: 47.5rem){\n                &::after{\n                    display: none;\n                }\n            }\n    }\n\n    div &__slide{\n        display: flex;\n        flex-direction: column;\n        width: 13rem;\n        height: 10rem;\n        border: solid $border;\n        border-radius: 0.4rem;\n        background-color: $white;\n        position: relative;\n        margin-bottom: 2rem;\n    }\n\n    &__slide-text{\n        padding-top: 1rem;\n        padding-left: 1rem;\n    }\n\n    &__slide-btn{\n        position: absolute;\n        bottom: 1rem;\n        right: 1rem;\n\n\n        // display: flex;\n        // align-items: flex-end; сохраняю если потребуется вернуть кнопку в поток\n        // padding-bottom: 1rem;\n        // padding-left: 1rem;\n    }\n\n   &__slider-wrapper{\n    @media (min-width: 47.5rem){\n        display: flex;\n        flex-wrap: wrap;\n        gap: 1.5rem;\n    }\n   }\n\n   &__btn-onclick{\n    display: none;\n    position: relative;\n    font-family: 'TT Lakes';\n    font-style: normal;\n    font-weight: 500;\n    font-size: 1rem;\n    line-height: 1.5rem;\n    padding-top: 1.5rem;\n    padding-left: 2rem;\n\n    &::before{\n    content: \"«\";\n    position: absolute;\n    font-size: 1.6rem;\n    -webkit-transform: rotate(0.75turn);\n    transform: rotate(0.75turn);\n    left: 0.2rem;\n    color: #41f6d7;\n    }\n    @media (min-width: 47.5rem){\n        display: block;\n    }\n}\n}\n.swiper-wrapper{\n    overflow: hidden;\n}",".price{\n    &__title-container{\n        border-top: solid $line;\n        height: 5rem;\n        background: linear-gradient(156deg, #F8F8F8 0%, #FFFFFF 98.61%);\n        margin-top: 2rem;\n        margin-bottom: 2rem;\n    }\n\n    &__title{\n        font-family: 'TT Lakes';\n        font-size: 1rem;\n        line-height: 1.5rem;\n        text-transform: uppercase;\n        color: $text;\n        padding: 1rem;\n    }\n\n    \n    &__slider{\n        position: relative;\n\n        &::after{\n            content: \"\";\n            position: absolute;\n            top: -0.75rem;\n            left: 16rem;\n            z-index: 5;\n            width: 2rem;\n            height: 13.8rem;\n            background: linear-gradient(270deg, #F8F8F8 16.84%, rgba(248, 248, 248, 0.0001) 100%);\n            }\n\n            \n            @media (min-width: 47.5rem){\n                &::after{\n                    display: none;\n                }\n            }\n    }\n\n    div &__slide{\n        width: 16.3rem;\n        height: 12.5rem;\n        border: solid $border;\n        border-radius: 0.4rem;\n        background-color: $white;\n        position: relative;\n        margin-bottom: 2rem;\n\n        @media (min-width: 47.5rem){\n            width: 45rem;\n            height: 4.1rem;\n            margin-bottom: 0;\n            border: none;\n            border-radius: none;\n\n            &:not(:last-child)::before{\n                content: \"\";\n                border-bottom: solid $border;\n                width: 688px;\n                display: block;\n                position: absolute;\n                bottom: 1px;\n                align-items: center;\n                align-content: center;\n                left: 2%;\n            }\n        }\n    }\n\n    &__slide-content{\n        padding-top: 1rem;\n        padding-left: 1rem;\n        max-width: 16.25rem;\n\n        @media (min-width: 47.5rem){\n            display: grid;\n            grid-template-columns: 22rem 3rem 5.1rem;\n            grid-gap: 43px;\n        }\n    }\n\n    &__slide-text{\n        padding-top: 1rem;\n        padding-left: 1rem;\n    }\n\n    &__slide-lining{\n        @media (min-width: 47.5rem){\n           \n        }\n    }\n\n    &__slide-title{\n        font-family: 'TT Lakes';\n        font-size: 0.9rem;\n        line-height: 1rem;\n        color: $text;\n        padding-bottom: 0.25rem;\n\n        @media (min-width: 47.5rem){\n            display: none;\n        }\n    }\n\n    &__slide-lining{\n        font-family: 'TT Lakes';\n        font-size: 0.9rem;\n        line-height: 1.1rem;\n        padding-bottom: 1rem;\n    }\n\n    &__slide-btn{\n        font-family: 'TT Lakes';\n        font-size: 1rem;\n        line-height: 1.5rem;\n        color: $white;\n        width: 4rem;\n        height: 1.5rem;\n        padding: 0.25rem 2.5rem 0.25rem 0.8rem;\n        background: $pink;\n        border-radius: 1rem;\n        position: relative;\n        float: right;\n        margin-top: -3rem;\n        margin-right: 1rem;\n\n        &::after{\n            content: \"\";\n            position: absolute;\n            display: block;\n            top: 0.8rem;\n            right: 0.7rem;\n            border: solid 2px $white;\n            border-radius: 7px;\n            background-color: $white;\n            width: 0.4rem;\n            -webkit-transform: rotate(45deg);\n            transform: rotate(45deg);\n        }\n        &::before{\n            content: \"\";\n            position: absolute;\n            display: block;\n            top: 1.1rem;\n            right: 0.7rem;\n            border: solid 2px $white;\n            border-radius: 7px;\n            background-color: $white;\n            width: 0.4rem;\n            -webkit-transform: rotate(130deg);\n            transform: rotate(130deg);\n        }\n\n        @media (min-width: 47.5rem){\n            display: block;\n            margin-top: -2.5rem;\n        }\n    }\n\n    &__info{\n        margin-top: 1rem;\n    }\n\n    &__info-text{    \n    font-family: 'TT Lakes';\n    font-size: 0.9rem;\n    line-height: 1.25rem;\n    margin-bottom: 1rem;\n    }\n\n    &__info-link{\n        font-family: 'TT Lakes';\n        font-size: 1rem;\n        line-height: 1.5rem;\n        text-transform: uppercase;\n        padding-right: 1rem;\n    }\n\n    &__slider-wrapper{\n        @media (min-width: 47.5rem){\n            display: flex;\n            flex-direction: column;\n            gap: 0;\n            max-width: 45rem;\n            border: solid $white;\n            border-radius: 0.4rem;\n        }\n       }\n\n       &__title-desctop{\n        display: none;\n\n        @media (min-width: 47.5rem){\n            font-family: 'TT Lakes';\n            font-size: 0.9rem;\n            line-height: 1rem;\n            color: $text;\n            padding-left: 1rem;\n            display: grid;\n            grid-template-columns: 23rem 3rem 5.1rem;\n            grid-gap: 43px;\n            margin-bottom: 1rem;\n        }\n       }\n}",".footer{\n    display: flex;\n    flex-direction: column;\n    text-align: center;\n    opacity: 0.72;\n    border-top: solid $line;\n    margin-top: 2.5rem;\n\n    &__content{\n        font-family: 'TT Lakes';\n        font-size: 1rem;\n        line-height: 1rem;\n        color: $text;\n        mix-blend-mode: normal;\n        margin-top: 1rem;\n        padding-bottom: 1rem;\n    }\n}",null],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/******/ })()
;
//# sourceMappingURL=main.9dc382c2ef9de3170795.js.map